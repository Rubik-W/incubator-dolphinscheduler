...
//        improssProcessCheckData(file, loginUser, currentProjectName, processMetaJson);
     ...
     */
    @Test
    public void testResetDagTaskNodesByDataLineage() throws Exception {
        Method method = ProcessDefinitionService.class.getDeclaredMethod("resetDagTaskNodesByDataLineage", ProcessDag.class, int.class);
        ...
        method.invoke(processDefinitionService, processDag, 1);

        Assert.assertEquals(5, processDag.getNodes().size());
    }
